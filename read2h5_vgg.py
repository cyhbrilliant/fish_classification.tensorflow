...
for i in range(ALB_num):
    print(i)
    tempimg=utils.load_image('train/ALB/'+str(i)+'.jpg')
    tempimg = tempimg.astype(np.float32)
    tempimg_flip=np.zeros(tempimg.shape)
    for m in range(224):
        for n in range(224):
            tempimg_flip[m,n,:]=tempimg[m,223-n,:]
    plt.imshow(tempimg_flip)
    plt.show()
...
for i in range(BET_num):
    print(i)
    tempimg=utils.load_image('train/BET/'+str(i)+'.jpg')
    tempimg = tempimg.astype(np.float32)
    for m in range(224):
        for n in range(224):
            tempimg_flip[m,n,:]=tempimg[m,223-n,:]
...
for i in range(DOL_num):
    print(i)
    tempimg=utils.load_image('train/DOL/'+str(i)+'.jpg')
    tempimg = tempimg.astype(np.float32)
    for m in range(224):
        for n in range(224):
            tempimg_flip[m,n,:]=tempimg[m,223-n,:]
...
for i in range(LAG_num):
    print(i)
    tempimg=utils.load_image('train/LAG/'+str(i)+'.jpg')
    tempimg = tempimg.astype(np.float32)
    for m in range(224):
        for n in range(224):
            tempimg_flip[m,n,:]=tempimg[m,223-n,:]
...
for i in range(NoF_num):
    print(i)
    tempimg=utils.load_image('train/NoF/'+str(i)+'.jpg')
    tempimg = tempimg.astype(np.float32)
    for m in range(224):
        for n in range(224):
            tempimg_flip[m,n,:]=tempimg[m,223-n,:]
...
for i in range(OTHER_num):
    print(i)
    tempimg=utils.load_image('train/OTHER/'+str(i)+'.jpg')
    tempimg = tempimg.astype(np.float32)
    for m in range(224):
        for n in range(224):
            tempimg_flip[m,n,:]=tempimg[m,223-n,:]
...
for i in range(SHARK_num):
    print(i)
    tempimg=utils.load_image('train/SHARK/'+str(i)+'.jpg')
    tempimg = tempimg.astype(np.float32)
    for m in range(224):
        for n in range(224):
            tempimg_flip[m,n,:]=tempimg[m,223-n,:]
...
for i in range(YFT_num):
    print(i)
    tempimg=utils.load_image('train/YFT/'+str(i)+'.jpg')
    tempimg = tempimg.astype(np.float32)
    for m in range(224):
        for n in range(224):
            tempimg_flip[m,n,:]=tempimg[m,223-n,:]
...
file = h5py.File('H5fish_vgg2.h5','w')
