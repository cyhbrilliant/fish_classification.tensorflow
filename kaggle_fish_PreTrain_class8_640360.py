...
saver.restore(sess,'session_class8/session8_5.ckpt')
for iter in range(100000):
    ...
    print(error,acc)
    if (iter + 1) % 20 == 0:
        print(sess.run(loss,feed_dict={Xp:DATA_ALL[3400:3410,:,:,:],Yp:LABEL8[3400:3410,:],train_mode:False}))
    if (iter+1)%200==0:
        path = saver.save(sess,'session_class8/session8_5.ckpt')
        print(path)