...
conv3_bn=tf.nn.max_pool(tf.nn.relu(batch_norm(conv3,True)),ksize=[1,2,2,1],strides=[1,2,2,1],padding='SAME')
...
conv4_bn=tf.nn.max_pool(tf.nn.relu(batch_norm(conv4,True)),ksize=[1,2,2,1],strides=[1,2,2,1],padding='SAME')
...
conv6_bn=tf.nn.max_pool(tf.nn.relu(batch_norm(conv6,True)),ksize=[1,2,2,1],strides=[1,2,2,1],padding='SAME')
...
conv8_bn=tf.nn.max_pool(tf.nn.relu(batch_norm(conv8,True)),ksize=[1,2,2,1],strides=[1,2,2,1],padding='SAME')
...
# TrainStep=tf.train.AdadeltaOptimizer(0.0001).minimize(loss)
...
saver.restore(sess,'session_class8_small/session1.ckpt')
